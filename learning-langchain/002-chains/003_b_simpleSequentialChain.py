...
# this is a modification on top of previous program where we have defined a
# lamda function and then called it directly
...
print_title = RunnableLambda(lambda titleOp: (print(f"Generated Title:{titleOp} \n")))



first_chain = prompt_template1 | llm | StrOutputParser() | print_title
