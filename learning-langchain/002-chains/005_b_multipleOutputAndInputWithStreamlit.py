...
# this is the same previous program but using steamlit
...
prompt_template2 = PromptTemplate(
    ...
    template="""
    You need to write a powerful and {emotion} speech of 350 words for the following title:
...
final_chain = first_chain | (lambda chain1Output: {"title":chain1Output,"emotion": emotionInput}) |second_chain

#enter an input like: ai and ethics
topicInput = st.text_input("Enter a topic")
emotionInput = st.text_input("Enter an emotion")
